...
let expName = 'templeton2A_SD67.psyexp';  // from the Builder filename that created this script
let expInfo = {'participant': '001', 'EyeTrack': False};
...
function instructions_4to5RoutineBegin(snapshot) {
  return function () {
    ...
    instructions_4to5Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instruction_67RoutineBegin(snapshot) {
  return function () {
    ...
    instruction_67Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instruction_67bRoutineBegin(snapshot) {
  return function () {
    ...
    instruction_67bComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instruction_7RoutineBegin(snapshot) {
  return function () {
    ...
    instruction_7Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function main_exp_blocksLoopBegin(main_exp_blocksLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  main_exp_blocks.forEach(function() {
...
function load_practice_trialsRoutineBegin(snapshot) {
  return function () {
    ...
    load_practice_trialsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function get_ready_practiceRoutineBegin(snapshot) {
  return function () {
    ...
    get_ready_practiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function blank_at_trial_startRoutineBegin(snapshot) {
  return function () {
    ...
    blank_at_trial_startComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function practice_mem_displayRoutineBegin(snapshot) {
  return function () {
    ...
    practice_mem_displayComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function retention_cue_and_test_intval_practice_2RoutineBegin(snapshot) {
  return function () {
    ...
    retention_cue_and_test_intval_practice_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function confidence_rating_practiceRoutineBegin(snapshot) {
  return function () {
    ...
    confidence_rating_practiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instructions_specific_trainingRoutineBegin(snapshot) {
  return function () {
    ...
    instructions_specific_trainingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function eyetracker_calibRoutineBegin(snapshot) {
  return function () {
    ...
    eyetracker_calibComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function load_training_trialsRoutineBegin(snapshot) {
  return function () {
    ...
    load_training_trialsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function get_ready_training_blockstartRoutineBegin(snapshot) {
  return function () {
    ...
    get_ready_training_blockstartComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function training_mem_displayRoutineBegin(snapshot) {
  return function () {
    ...
    training_mem_displayComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function retention_cue_and_test_intval_trainingRoutineBegin(snapshot) {
  return function () {
    ...
    retention_cue_and_test_intval_trainingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function confidence_rating_trainingRoutineBegin(snapshot) {
  return function () {
    ...
    confidence_rating_trainingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instruction_8RoutineBegin(snapshot) {
  return function () {
    ...
    instruction_8Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function load_real_trialsRoutineBegin(snapshot) {
  return function () {
    ...
    load_real_trialsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function get_ready_real_blockstartRoutineBegin(snapshot) {
  return function () {
    ...
    get_ready_real_blockstartComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function real_mem_displayRoutineBegin(snapshot) {
  return function () {
    ...
    real_mem_displayComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function retention_cue_and_test_intval_realRoutineBegin(snapshot) {
  return function () {
    ...
    retention_cue_and_test_intval_realComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function confidence_rating_real_2RoutineBegin(snapshot) {
  return function () {
    ...
    confidence_rating_real_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
